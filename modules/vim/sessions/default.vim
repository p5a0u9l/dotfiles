" ~/dotfiles/modules/vim/sessions/default.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 17 November 2017 at 21:20:59.
...
set shortmess=aoO
badd +0 clamm/clamm.py
badd +0 setup.py
badd +0 clamm/tags.py
argglobal
silent! argdel *
...
1resize 40|vert 1resize 31|2resize 40|vert 2resize 95|3resize 40|vert 3resize 45|
1wincmd w
tabnext 2
let s:bufnr_save = bufnr("%")
let s:cwd_save = getcwd()
